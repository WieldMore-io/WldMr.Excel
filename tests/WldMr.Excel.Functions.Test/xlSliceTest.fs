...
type ``xlSlice``() =
  ...
  member __.``arguments are defaulted``() =
    ...
    (a22, missing, missing, missing, missing, missing, missing)
    |> Slice.xlSlice
  ...
  member __.``select rows``() =
    ...
    (a33, 2.0 |> XlObj.ofFloat, -2.0 |> XlObj.ofFloat, missing, missing, missing, missing)
    |> Slice.xlSlice
  ...
  member __.``select last row``() =
    let a33 = [[11; 12; 13];[21;22;23];[31; 32; 33]] |> toArrayObj
    (a33, -1.0 |> XlObj.ofFloat, -1.0 |> XlObj.ofFloat, missing, missing, missing, missing)
    |> Slice.xlSlice
  ...
  member __.``select center``() =
    let a33 = [[11; 12; 13]; [21;22;23]; [31; 32; 33]] |> toArrayObj
    (a33, 2.0 |> XlObj.ofFloat, -2.0 |> XlObj.ofFloat, 2.0 |> XlObj.ofFloat, -2.0 |> XlObj.ofFloat, missing, missing)
    |> Slice.xlSlice
  ...
  member __.``3, 4, 1, -2``() =
    ...
    (a56, 3.0 |> XlObj.ofFloat, 4.0 |> XlObj.ofFloat, 1.0 |> XlObj.ofFloat, -2.0 |> XlObj.ofFloat, missing, missing)
    |> Slice.xlSlice
